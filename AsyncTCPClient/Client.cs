...
namespace AsyncTCPClient {
    ...
    public class Client<T>where T:Common.Protocol.Protocol,new() {
        ...
        Common.OpMessage opMessage;// = new Common.OpMessage();
        T protocol;
        ...
        public void Start(Queue<KeyValuePair<Socket, DataPack<NormalProtocol>>> queue, string addr="127.0.0.1",int port=9999)
        {
            HandlerCenter.instance.InitHandler();
